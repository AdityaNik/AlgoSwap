export const bridgeContract = {
  address: '0x5f693e9B1B022640F05115Ff7f9E28E0d0947a08',
  abi: [
	{
		"inputs": [
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct BridgeETH.BridgeRequest",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				...
				"internalType": "struct BridgeETH.TokenConfig",
				"name": "",
				"type": "tuple"
			}
		],
